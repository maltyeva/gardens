...
class GardensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create garden" do
    assert_difference('Garden.count') do
      post gardens_url, params: { garden: { category: @garden.category, location: @garden.location, name: @garden.name } }
    end
  ...
  test "should update garden" do
    patch garden_url(@garden), params: { garden: { category: @garden.category, location: @garden.location, name: @garden.name } }
